...
import uk.co.mikepini.shrekgame.R;
...
public abstract class GameThread extends Thread {
    ...
    //The view
    public uk.co.mikepini.shrekgame.GameView mGameView;
    ...
    public GameThread(uk.co.mikepini.shrekgame.GameView gameView) {
        mGameView = gameView;
       ...
       mBackgroundImage = BitmapFactory.decodeResource(gameView.getContext().getResources(),R.drawable.mud);
    ...
    this.level=level;
        switch(level){
            case 1: mBackgroundImage = BitmapFactory.decodeResource(mGameView.getContext().getResources(),R.drawable.mud);
                break;
            case 2:mBackgroundImage = BitmapFactory.decodeResource(mGameView.getContext().getResources(),R.drawable.cobbled_floor);
                break;
            case 3: mBackgroundImage = BitmapFactory.decodeResource(mGameView.getContext().getResources(),R.drawable.level3bkgnd);
                break;
            default:mBackgroundImage = BitmapFactory.decodeResource(mGameView.getContext().getResources(),R.drawable.mud);
        }
    }
